export default function BlogItemSmall({ id, type, title, date, author, onClick }: any) {
  return (
    <article className="mt-[32px] border-t-[#787878] border-t-[1px] cursor-pointer" onClick={() => onClick(id)}>
