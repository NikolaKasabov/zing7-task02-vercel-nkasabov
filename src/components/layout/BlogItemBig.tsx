...
export default function BlogItemBig({ id, type, title, date, author, image, onClick }: any) {
  return (
    <article
      className="max-w-[1140px] flex justify-between gap-6 max-lg:flex-col max-lg:items-center cursor-pointer"
      onClick={() => onClick(id)}
    >
      <div className="max-w-[555px] w-full border-t-[#787878] border-t-[1px] border-b-[#787878] border-b-[1px] flex flex-col">
        ...
        <h3 className="mt-[13px] text-[40px] font-bold leading-[1.25] tracking-[-0.56px] max-lg:text-[32px]">
          {title}
        </h3>
